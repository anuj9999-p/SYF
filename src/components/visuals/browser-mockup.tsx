    ...
    <div className="overflow-hidden rounded-[10px] border border-ink/12 bg-paper shadow-[0_24px_60px_-28px_rgba(24,20,14,0.4)]">
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-[#E7C9A8] via-[#DCA97D] to-rust/60 p-3 sm:p-4">
        <div className="flex items-center justify-between">
          <span className="font-display text-[10px] font-bold tracking-wide text-ink/80 sm:text-xs">
            STAYORA
          </span>
          <div className="flex gap-1.5 sm:gap-2">
            <span className="h-1 w-3.5 rounded-full bg-ink/30 sm:w-4" />
            <span className="h-1 w-3.5 rounded-full bg-ink/30 sm:w-4" />
            <span className="h-1 w-3.5 rounded-full bg-ink/30 sm:w-4" />
          </div>
        </div>

        <div className="mt-4 h-2 w-2/3 rounded-full bg-ink/70 sm:mt-6" />
        <div className="mt-2 h-2 w-2/5 rounded-full bg-ink/40" />

        <span className="mt-4 inline-block rounded-full bg-lime px-3 py-1 font-display text-[9px] font-semibold tracking-tight text-ink sm:mt-5">
          Book your stay
        </span>

        <div className="mt-4 grid grid-cols-3 gap-1.5 sm:mt-5 sm:gap-2">
          <div className="aspect-square rounded-md bg-ink/15" />
          <div className="aspect-square rounded-md bg-ink/10" />
          <div className="aspect-square rounded-md bg-ink/20" />
        </div>
      </div>
    </div>
  );
